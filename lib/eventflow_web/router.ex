defmodule EventflowWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {EventflowWeb.Layouts, :root}
  ...
  if Application.compile_env(:eventflow, :dev_routes) do
  ...
  scope "/", EventflowWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{EventflowWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", EventflowWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/admin/events/:id", EventLive.Show, :show
      live "/admin/events/:id/show/edit", EventLive.Show, :edit
    end
  end
  ...
  scope "/", EventflowWeb do
    ...
    live_session :current_user,
      on_mount: [{EventflowWeb.UserAuth, :mount_current_user}] do
